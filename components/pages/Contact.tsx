...
const Contact = () => {
  return (
    ...
    <div
    className="grid md:grid-cols-2 mb-56 gap-16 mt-0 items-center relative overflow-hidden p-10 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-gray-800 text-[#333] my-6 font-[sans-serif] before:absolute before:right-0 before:w-[0px] before:bg-gray-900 before:h-full max-md:before:hidden">
      <div>
        
        <h2 className="text-3xl font-extrabold text-purple-400">Get In Touch</h2>
        <p className="text-sm text-slate-300 mt-3">Have a specific inquiry or looking to explore new opportunities? Our
        ...
        <form>
            <div className="space-y-4 mt-8">
                ...
                <textarea placeholder="Write Message"
                    className="px-2 pt-3 bg-gray-900 text-white w-full text-sm focus:border-[#333] outline-none"></textarea>
            </div>
            <button type="button"
