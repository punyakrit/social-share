...
import SkeletonLoader from "./SkeletonContributor";

const ITEMS_PER_PAGE = 10;

async function getContributors() {
  const res = await axios.get(
    "https://api.github.com/repos/punyakrit/social-share/contributors"
  );
  ...
  return (
    <div className="bg-gray-900 min-h-screen py-10 px-4 sm:px-8 lg:px-16 text-white ">
      <div className="max-w-screen-lg mx-auto">
        <h2 className="text-4xl font-extrabold text-center mb-12 mt-24">
          Our Contributors
        </h2>
        {loading ? (
          <SkeletonLoader />
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <div className="ml-4">
                        <h3 className="text-2xl font-semibold w-fit">
                          {truncateUsername(contributor.login)}
                        </h3>
